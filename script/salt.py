...
class saltAPI:
    def __init__(self):
        self.__url = 'https://192.168.149.129:8888'       #salt-api监控的地址和端口如:'https://192.168.186.134:8888'
        self.__user =  'saltapi'             #salt-api用户名
        self.__password = '1qazXDR%'          #salt-api用户密码
...
def main():
    ...
    #params = {'client':'local', 'fun':'cmd.run', 'arg':'free -m' ,'tgt':'*'}
